...
export async function basketPage(container) {
    ...
    `);
        ...
        const setError = (message) => {
            ...
            root.insertAdjacentHTML("afterbegin", `<p class="error basket-inline-error">${escapeHtml(message)}</p>`);
        };
        const refresh = async () => {
...
function bindBasketControls(root, refresh, setError) {
